        ...
        <div className="flex items-center justify-between">
            <div className='flex items-center'>
                <input
                    ...
                    onChange={onChange}
                />
                <label htmlFor="default-checkbox" className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                    {todo}
                </label>
            </div>
            <button type="button" className="ml-2 text-red-600 hover:text-red-800 focus:outline-none" onClick={onDelete}>
